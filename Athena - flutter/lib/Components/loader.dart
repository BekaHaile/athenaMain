...
class Loader extends StatefulWidget {
  ...
  Loader(
      {Key key,
      this.centralDotColor = const Color.fromRGBO(0, 165, 81, 1),
      this.dotOneColor = const Color.fromRGBO(213, 204, 41, 1),
      this.dotTwoColor = const Color.fromRGBO(84, 200, 132, 1),
      this.dotThreeColor = const Color.fromRGBO(231, 214, 86, 1),
      this.dotFourColor = Colors.green,
      this.dotFiveColor = const Color.fromRGBO(199, 189, 40, 1),
      this.dotSixColor = const Color.fromRGBO(0, 165, 81, 1),
      this.dotSevenColor = const Color.fromRGBO(221, 208, 6, 1),
...
class _LoaderTwoState extends State<Loader>
